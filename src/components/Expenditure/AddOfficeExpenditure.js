...
import './AddOfficeExpenditure.css';

import { BiAbacus, BiBrightness, BiStar, BiHive, BiUserPlus, BiShapePolygon, BiCalendarStar, BiSearchAlt2 } from "react-icons/bi";

const AddOfficeExpenditure = () => (
 
  <div className="AddOfficeExpenditure">
    <div id="main">
   

<div className="col-md-12">
<h5 className="card-title mt-5">Add Office Expenditure</h5> 
...
AddOfficeExpenditure.propTypes = {};

AddOfficeExpenditure.defaultProps = {};

export default AddOfficeExpenditure;
