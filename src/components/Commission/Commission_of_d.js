...
const Commission_of_d = () => {
    return (

        <div className="Commission_of_d">
            <div id="main">
                <div className="col-md-12 mt-5">

                    <h5> Due Commission</h5>
...
Commission_of_d.propTypes = {};

Commission_of_d.defaultProps = {};

export default Commission_of_d;