...
const Print_Commission = () => {
    return (

        <div className="Print_Commission">
            <div id="main">
                <div className="col-md-12 mt-5">

                    <h5>Print Commission</h5>
...
Print_Commission.propTypes = {};

Print_Commission.defaultProps = {};

export default Print_Commission;